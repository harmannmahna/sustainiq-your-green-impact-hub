...
import { FootprintProvider } from "@/lib/footprint-store";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SustainIQ — Your Climate Co-Pilot" },
      { name: "description", content: "Calculate, reduce, and offset your carbon footprint with gamified eco-action." },
      { property: "og:title", content: "SustainIQ — Your Climate Co-Pilot" },
